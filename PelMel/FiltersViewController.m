            ...
            switch (indexPath.row) {
                ...
                case kRowHoursSpecials:
                    ...
                    if(self.tableView.contentOffset.y==0) {
                        // Getting place type cell
                        CGRect rect = [self.tableView rectForRowAtIndexPath:[NSIndexPath indexPathForRow:kRowHoursSpecials inSection:kSectionPlaceType]];
                        rect = [self.tableView convertRect:rect toView:self.parentMenuController.view];
                        
                        // Adjusting rect for help display
                        rect = CGRectInset(rect, 10, 5);
