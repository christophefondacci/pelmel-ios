...
typedef enum {
    PMLThumbNone, PMLThumbsLike,PMLThumbsCheckin,PMLThumbsUserLike, PMLThumbsUsersInEvent, PMLThumbsOther, PMLThumbsLocation, PMLThumbShowMore,PMLThumbChatUsers
} PMLThumbType;
